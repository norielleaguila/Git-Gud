...
public class Game {
	...
	public boolean checkWin(int row, int col, int board, String marker){
		...
		if(boards[0].getBlock(row, col).getMarker().equals(marker) 
				&& boards[1].getBlock(row, col).getMarker().equals(marker) 
				&& boards[2].getBlock(row, col).getMarker().equals(marker))
			return true;
		...
		if(col == 0){
			if(boards[0].getBlock(row, col+1).getMarker().equals(marker) && boards[0].getBlock(row, col+2).getMarker().equals(marker))
				return true;
			if(boards[1].getBlock(row, col+1).getMarker().equals(marker) && boards[2].getBlock(row, col+2).getMarker().equals(marker))
				return true;
		}
		else if(col == 1){
			if(boards[0].getBlock(row, col-1).getMarker().equals(marker) && boards[0].getBlock(row, col+1).getMarker().equals(marker))
				return true;
			if(boards[1].getBlock(row, col-1).getMarker().equals(marker) && boards[2].getBlock(row, col+1).getMarker().equals(marker))
				return true;
		}
		else if(col == 2){
			if(boards[0].getBlock(row, col-1).getMarker().equals(marker) && boards[0].getBlock(row, col-2).getMarker().equals(marker))
		...
		if(row == 0){
			if(boards[0].getBlock(row+1, col).getMarker().equals(marker) && boards[0].getBlock(row+2, col).getMarker().equals(marker))
				return true;
			if(boards[1].getBlock(row+1, col).getMarker().equals(marker) && boards[2].getBlock(row+2, col).getMarker().equals(marker))
				return true;
		}
		else if(row == 1){
			if(boards[0].getBlock(row-1, col).getMarker().equals(marker) && boards[0].getBlock(row+1, col).getMarker().equals(marker))
				return true;
			if(boards[1].getBlock(row-1, col).getMarker().equals(marker) && boards[2].getBlock(row+1, col).getMarker().equals(marker))
				return true;
		}
		else if(row == 2){
			if(boards[0].getBlock(row-1, col).getMarker().equals(marker) && boards[0].getBlock(row-2, col).getMarker().equals(marker))
